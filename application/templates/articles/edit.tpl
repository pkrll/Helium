                                ...
                                <div class="stylized-form-row dragzone" id="dragzone-image">
                                    ...
                                    <div class="input">
                                        ...
                                        <div class="image-container">
                                            <?php
                                                foreach ($contents["images"]["normal"] AS $key => $image) {
                                            ?>
                                            <div class="picture" data-id="<?=$image['id']?>">
                                                ...
                                                <div class="caption">
                                                    <div>
                                                        <span class="image-event-button" data-type="image" data-action="remove" data-id="<?=$image['id']?>" data-edit="true">
                                                            <span class="font-icon icon-cancel"></span> Remove image
                                                        </span>
                                                    </div>
                                                    <div>
                                                        <input type="text" name="caption-image[]" placeholder="Caption" value="<?=$image['caption']?>">
                                ...
                                <div class="stylized-form-row dragzone" id="dragzone-cover">
                                    ...
                                    <div class="input cover">
                                        <div>
                                            ...
                                            <span class="image-event-button" data-type="cover" data-action="remove" data-id="<?=$contents['images']['cover']['id']?>" data-edit="true">
