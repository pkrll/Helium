                <form id="article" action="/articles/create" method="POST">
                    <div class="split-view">
                        ...
                        <div class="left-view">
                            ...
                            <div style="font-family: 'Dosis', sans-serif; font-size: 30px; line-height:20px; margin: 18px 0 18px 0; text-align: center;">
                                <span class="font-icon icon-pencil" style="line-height:20px;font-size:18px;"></span> New post
                            </div>

                            <div class="view-section">
                                <label>
                                    <span class="section-label">Headline</span>
                                    <input type="text" name="headline" id="headlien" required="required" />
                                </label>
                            ...
                            <div class="view-section">
                                <label>
                                    ...
                                    <textarea name="body" id="body" required="required"><?=$contents["article"]["preamble"]?></textarea>
                                </label>
                            </div>
